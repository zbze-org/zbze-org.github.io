import{d as _,u as d,a as h,c as m,b as p,r as u,o as s,e as n,f as t,t as a,g as l,F as g,h as f,n as v,i as b,j as x,k as y,l as N,m as P,_ as k}from"./index-i52deSTr.js";import{N as z}from"./NoteDisplay-ebFfvfdy.js";const w={class:"m-4"},V={class:"mb-10"},L={class:"text-4xl font-bold mt-2"},S={class:"opacity-50"},T={class:"text-lg"},j={class:"font-bold flex gap-2"},B={class:"opacity-50"},D=t("div",{class:"flex-auto"},null,-1),H={key:0,class:"border-gray-400/50 mb-8"},C=_({__name:"PresenterPrint",setup(F){d(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
